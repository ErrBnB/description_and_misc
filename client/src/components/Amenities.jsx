    ...
    return (
      <div style={{marginBottom: 16}}>
        <div className="_qtix31">
          ...
          <div className="_ni9axhe">
            <div className="_ncwphzu">Kitchen</div>
          </div>
        </div>
      </div>
    )
    ...
    return (
      <div style={{marginBottom: 16}}>
        <div className="_qtix31">
          ...
          <div className="_ni9axhe">
            <div className="_ncwphzu">Wifi</div>
          </div>
        </div>
      </div>
    )
    ...
    return (
      <div style={{marginBottom: 16}}>
        <div className="_qtix31">
          ...
          <div className="_ni9axhe">
            <div className="_ncwphzu">Dryer</div>
          </div>
        </div>
      </div>
    )
    ...
    return (
      <div style={{marginBottom: 16}}>
        <div className="_qtix31">
          ...
          <div className="_ni9axhe">
            <div className="_ncwphzu">Hair dryer</div>
          </div>
        </div>
      </div>
    )
    ...
    return (
      <div style={{marginBottom: 16}}>
        <div className="_qtix31">
          ...
          <div className="_ni9axhe">
            <div className="_ncwphzu">Washer</div>
          </div>
        </div>
      </div>
    )
    ...
    return (
      <div style={{marginBottom: 16}}>
        <div className="_qtix31">
          ...
          <div className="_ni9axhe">
            <div className="_ncwphzu">Laptop friendly workspace</div>
          </div>
        </div>
      </div>
    )
  ...
  render () {
    return (
      <div style={{marginTop: 8}}>
        <div className="_1n57hdr7"><button type="button" className="_n5wk6ic" aria-busy="false"><span>Show all 28 amenities</span></button></div>
      </div>
    )
  }
}
